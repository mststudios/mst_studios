...
export const CALCULATOR_STEPS = [
  {
    ...
    options: [
      ...
      },
      {
        ...
        sub: 'Sælg produkter direkte fra hjemmesiden (kræver e-handels-løsning)',
        minPrice: 0,
        maxPrice: 0,
        monthlyPrice: 0,
    ...
    options: [
      {
        ...
        sub: 'Fortæl om din virksomhed og få kunder til at kontakte dig',
        minPrice: 2999,
        maxPrice: 2999,
        monthlyPrice: 0,
      ...
      },
      {
        ...
        sub: 'Fremvis dit arbejde og skab troværdighed hos nye kunder',
        minPrice: 3999,
        maxPrice: 3999,
        monthlyPrice: 0,
      ...
      },
      {
        ...
        sub: 'Sælg produkter direkte online – større projekt, større muligheder',
        minPrice: 4999,
        maxPrice: 4999,
        monthlyPrice: 0,
        icon: <ShoppingBag className="w-5 h-5" />
  ...
  },
  {
    ...
    options: [

      {
        ...
        sub: 'Bliv fundet på Google — mere trafik, flere kunder',
        minPrice: 1000,
        maxPrice: 1000,
        monthlyPrice: 0,
