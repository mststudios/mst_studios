...
const Hero: React.FC<{ onOpenCalc: () => void }> = ({ onOpenCalc }) => {
  return (
    <section id="forside" className="relative pt-24 pb-20 lg:pt-32 lg:pb-32 overflow-hidden bg-slate-900">
      {/* Background Effects */}
        ...
        <div className="grid lg:grid-cols-12 gap-12 items-center">
          <div className="z-10 text-center lg:text-left lg:col-span-7">
            ...
            <div className="flex flex-wrap gap-2 mt-12 justify-center lg:justify-start">
              <span className="bg-yellow-500/10 border border-yellow-500/20 rounded-full px-4 py-1.5 text-xs font-bold text-yellow-300">
                ⚡ Under 14 dage
              </span>
              <span className="bg-emerald-500/10 border border-emerald-500/20 rounded-full px-4 py-1.5 text-xs font-bold text-emerald-300">
                ✓ Fast pris
              </span>
              <span className="bg-blue-500/10 border border-blue-500/20 rounded-full px-4 py-1.5 text-xs font-bold text-blue-300">
                📱 Mobiloptimeret
              </span>
          ...
          <div className="relative hidden lg:block lg:col-span-5">
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[110%] h-[110%] bg-blue-500/10 rounded-full blur-[80px] animate-pulse-glow pointer-events-none" />
            <div className="absolute top-0 right-0 w-40 h-40 bg-purple-500/10 rounded-full blur-[60px] animate-pulse-glow pointer-events-none" style={{ animationDelay: '1s' }} />
            <div className="absolute bottom-0 left-10 w-32 h-32 bg-teal-500/10 rounded-full blur-[50px] animate-pulse-glow pointer-events-none" style={{ animationDelay: '2s' }} />

            <div className="relative w-full" style={{ height: '400px' }}>

              {/* --- DESKTOP MONITOR --- */}
              <div className="animate-float-desktop absolute left-1/2 -translate-x-1/2 top-5 w-[280px] z-[1]">
                <div className="bg-slate-800 border border-white/10 rounded-xl p-1.5 shadow-2xl shadow-black/50">
                  {/* Browser bar */}
                  <div className="bg-slate-900 rounded-t-lg h-5 flex items-center px-3 gap-1.5 border-b border-white/5">
                  ...
                  {/* Screen */}
                  <div className="bg-gradient-to-br from-[#1e3a5f] to-[#1e1b4b] rounded-b-lg h-36 p-3 overflow-hidden">
                ...
                {/* Monitor stand */}
                <div className="w-10 h-2.5 bg-slate-800 border border-white/10 border-t-0 rounded-b mx-auto" />
                <div className="w-16 h-1 bg-slate-800 border border-white/10 rounded mx-auto" />
              </div>

              {/* --- TABLET --- */}
              <div className="animate-float-tablet absolute left-[2%] top-[60px] w-[115px] z-[2]">
                <div className="bg-slate-800 border border-white/10 rounded-xl p-1 shadow-2xl shadow-black/50">
                  <div className="bg-gradient-to-br from-[#1e3a5f] to-[#2d1b4b] rounded-lg h-44 p-2.5 overflow-hidden">
                  ...
                  <div className="w-5 h-5 rounded-full border border-white/10 mx-auto my-1" />
                </div>
              </div>

              {/* --- PHONE --- */}
              <div className="animate-float-phone absolute right-[2%] top-[50px] w-[75px] z-[2]">
                <div className="bg-slate-800 border border-white/10 rounded-2xl p-1 shadow-2xl shadow-black/50">
                  <div className="w-6 h-1.5 bg-slate-900 rounded-full mx-auto mb-1" />
                  <div className="bg-gradient-to-br from-[#1e3a5f] to-[#2d1b4b] rounded-xl h-36 p-2 overflow-hidden">
                  ...
                  <div className="w-4 h-4 rounded-full border border-white/10 mx-auto my-1" />
                </div>
              </div>

              {/* --- FLOATING CARD 1 — top left — Speed --- */}
              <div className="animate-bounce-card absolute top-0 left-[16%] z-10 bg-slate-900/90 backdrop-blur-xl border border-white/10 rounded-2xl px-3 py-2 shadow-xl flex items-center gap-2.5 whitespace-nowrap">
                ...
                <div>
                  <p className="text-[9px] font-bold text-slate-500 uppercase tracking-widest">Fra idé til online</p>
                  <p className="text-xs font-black text-white">Under 14 dage</p>
                </div>
              </div>

              {/* --- FLOATING CARD 2 — bottom center — Pricing --- */}
              <div className="animate-bounce-card absolute bottom-16 left-[10%] z-10 bg-slate-900/90 backdrop-blur-xl border border-white/10 rounded-2xl px-3 py-2 shadow-xl flex items-center gap-2.5 whitespace-nowrap">
                ...
                <div>
                  <p className="text-[9px] font-bold text-slate-500 uppercase tracking-widest">Budgetvenlige priser</p>
                  <p className="text-xs font-black text-white">Tilpasset til dig</p>
                </div>
              </div>

              {/* --- FLOATING CARD 3 — right — All devices --- */}
              <div className="absolute top-[30%] right-0 z-10 bg-slate-900/90 backdrop-blur-xl border border-white/10 rounded-2xl px-3 py-2 shadow-xl flex items-center gap-2.5 whitespace-nowrap">
                ...
                <div>
                  <p className="text-[9px] font-bold text-slate-500 uppercase tracking-widest">Optimeret til</p>
...
const Process: React.FC<{ onOpenCalc: () => void }> = ({ onOpenCalc }) => {
  ...
  return (
    <section id="proces" className="py-32 bg-slate-800 text-white overflow-hidden rounded-[4rem] mx-4 md:mx-8 my-10 relative border border-white/5 shadow-2xl" ref={containerRef}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="relative">
          ...
          <div className="hidden lg:block absolute top-[52px] left-[12.5%] right-[12.5%] h-px bg-gradient-to-r from-blue-500/30 via-purple-500/30 to-emerald-500/30 z-0" />
            ...
            {[
              ...
              <div key={idx} className={`flex flex-col items-center lg:items-start text-center lg:text-left ${isVisible ? `animate-fade-up animate-fade-up-delay-${(idx % 4) + 1}` : 'opacity-0'}`}>
                ...
                <div className={`relative w-14 h-14 rounded-2xl ${step.bg} border ${step.border} flex items-center justify-center mb-6 shadow-xl ${step.glow} ${step.text}`}>
                  <div className={`absolute -top-2 -right-2 w-5 h-5 rounded-full bg-slate-900 border ${step.border} flex items-center justify-center`}>
...
const Portfolio: React.FC = () => {
  ...
  return (
    <section id="portfolio" className="py-32 bg-slate-900 overflow-hidden relative" ref={containerRef}>
...
const AboutMe: React.FC = () => {
  ...
  return (
    <section id="om-mig" className="py-32 bg-slate-900 overflow-hidden relative" ref={containerRef}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-20 items-center">
          ...
          <div className={`relative lg:col-span-5 ${isVisible ? 'animate-fade-up' : 'opacity-0'}`}>
            ...
            <div className="relative rounded-[3rem] overflow-hidden shadow-2xl border-4 border-slate-800">
              <img
            ...
            <div className="absolute top-6 left-6 z-10 bg-slate-900/90 backdrop-blur-xl border border-white/10 rounded-2xl px-4 py-3 shadow-xl flex items-center gap-3">
            ...
            <div className="absolute -bottom-6 -right-4 z-10 bg-slate-900/90 backdrop-blur-xl border border-white/10 rounded-2xl px-4 py-3 shadow-xl flex items-center gap-3 animate-bounce-slow">
              <div className="w-8 h-8 rounded-xl bg-blue-500/15 border border-blue-500/30 flex items-center justify-center">
                <Code className="w-4 h-4 text-blue-400" />
              </div>
              <div>
                <p className="text-[10px] font-bold text-slate-500 uppercase tracking-widest">Tilgang</p>
          ...
          <div className={`space-y-8 lg:col-span-7 ${isVisible ? 'animate-fade-up animate-fade-up-delay-2' : 'opacity-0'}`}>
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-white italic tracking-tight leading-tight">
              Fra hobby til <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400 pb-2 pr-2">
                Digitalt Talent
              </span>
            </h2>
            ...
            <div className="grid grid-cols-3 gap-4">
              <div className="bg-slate-800/80 border border-white/5 rounded-2xl p-4 text-center">
                <div className="w-8 h-8 rounded-xl bg-purple-500/15 border border-purple-500/30 flex items-center justify-center mx-auto mb-2">
                  <Users className="w-4 h-4 text-purple-400" />
                </div>
                <p className="text-xs font-black text-white mb-1">Fuld fokus</p>
                <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest leading-tight">Én kunde ad gangen</p>
              </div>
              <div className="bg-slate-800/80 border border-white/5 rounded-2xl p-4 text-center">
                <div className="w-8 h-8 rounded-xl bg-emerald-500/15 border border-emerald-500/30 flex items-center justify-center mx-auto mb-2">
                  <PhoneCall className="w-4 h-4 text-emerald-400" />
                </div>
                <p className="text-xs font-black text-white mb-1">Altid tilgængelig</p>
                <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest leading-tight">Hurtig kommunikation</p>
              </div>
              <div className="bg-slate-800/80 border border-white/5 rounded-2xl p-4 text-center">
                <div className="w-8 h-8 rounded-xl bg-blue-500/15 border border-blue-500/30 flex items-center justify-center mx-auto mb-2">
                  <Eye className="w-4 h-4 text-blue-400" />
                </div>
                <p className="text-xs font-black text-white mb-1">Transparent proces</p>
                <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest leading-tight">Du følger med hele vejen</p>
              </div>
            </div>
...
const Footer: React.FC<FooterProps> = ({ onOpenCalc, onOpenPrivacy, onOpenCookies }) => {
  ...
  return (
    <footer className="bg-slate-900 border-t-2 border-blue-500/20 pt-20 pb-10 relative overflow-hidden">
      {/* Background Ambience */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-16">
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-gradient-to-br from-slate-800 to-slate-900 rounded-xl flex items-center justify-center border border-white/10 shadow-lg shadow-blue-500/30">
                <span className="text-white font-bold text-xl leading-none">M</span>
              </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <button onClick={onOpenCalc} className="group flex items-center gap-3 text-slate-400 hover:text-emerald-400 transition-colors text-sm font-medium w-full text-left">
                  <span className="group-hover:translate-x-1 transition-transform">Brug Prisberegneren</span>
                </button>
              </li>
              <li>
                <a href="mailto:contact@mststudios.com" className="group flex items-center gap-3 text-slate-400 hover:text-emerald-400 transition-colors text-sm font-medium">
                  <span className="group-hover:translate-x-1 transition-transform">Send en mail</span>
                </a>
              </li>
              <li>
                <a href="tel:+4530431964" className="group flex items-center gap-3 text-slate-400 hover:text-emerald-400 transition-colors text-sm font-medium">
            ...
            <ul className="space-y-6">
              <li>
                <div className="flex items-start gap-4 group cursor-default">
                  <div className="w-8 h-8 rounded-full bg-slate-900 border border-white/20 flex items-center justify-center text-slate-300 group-hover:text-white group-hover:border-blue-500/30 transition-all shadow-md group-hover:shadow-blue-500/20">
              ...
              <li>
                <div className="flex items-start gap-4 group cursor-default">
                  <div className="w-8 h-8 rounded-full bg-slate-900 border border-white/20 flex items-center justify-center text-slate-300 group-hover:text-white group-hover:border-purple-500/30 transition-all shadow-md group-hover:shadow-purple-500/20">
              ...
              <li className="flex items-start gap-4">
                <div className="w-8 h-8 rounded-full bg-slate-900 border border-white/20 flex items-center justify-center text-slate-300">
